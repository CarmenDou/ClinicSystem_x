    ...
    (function() {
      ...
      function ib(d) {
        ...
        if (d.exportEnabled && d._dropdownMenu) {
          var p2 = d.theme && -1 !== d.theme.indexOf("dark") ? "black" : "#888888";
          K(
            d._dropdownMenu,
            { backgroundColor: d.toolbar.itemBackgroundColor, color: d.toolbar.fontColor, boxShadow: "2px 2px 10px " + p2 }
          );
          ...
          !d._dropdownMenu && (d.exportEnabled && v) && (l = false, d._dropdownMenu = document.createElement("div"), d._dropdownMenu.setAttribute("tabindex", -1), p2 = d.theme && -1 !== d.theme.indexOf("dark") ? "black" : "#888888", K(d._dropdownMenu, { position: "absolute", zIndex: 1, userSelect: "none", MozUserSeelct: "none", WebkitUserSelect: "none", msUserSelect: "none", cursor: "pointer", right: "0px", top: "25px", minWidth: "120px", outline: 0, fontSize: "14px", fontFamily: "Arial, Helvetica, sans-serif", padding: "5px 0px 5px 0px", textAlign: "left", lineHeight: "10px", backgroundColor: d.toolbar.itemBackgroundColor, boxShadow: "2px 2px 10px " + p2 }), d._dropdownMenu.style.display = "none", d._toolBar.appendChild(d._dropdownMenu), I(
            d._dropdownMenu,
            "blur",
            function() {
              xa(d._dropdownMenu);
            ...
            d.allDOMEventHandlers,
            true
          ), p2 = document.createElement("div"), K(p2, { padding: "12px 8px 12px 8px" }), p2.innerHTML = d._cultureInfo.printText, p2.style.backgroundColor = d.toolbar.itemBackgroundColor, p2.style.color = d.toolbar.fontColor, d._dropdownMenu.appendChild(p2), I(p2, "touchstart", function(d2) {
            l = true;
      ...
      t = Ra.Chart = function() {
        ...
        l.prototype._updateOptions = function() {
          ...
          this.stockChart && (this.stockChart.options && "undefined" !== typeof this.stockChart.options.theme && p(this.options.theme)) && (this.theme = this.stockChart.theme);
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
            ...
            this._resetButton ? (K(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && this._resetButton.childNodes[0] && K(this._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }), this._resetButton.title = this._cultureInfo.resetText) : (e = false, xa(this._resetButton = document.createElement("button")), ta(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), I(
              ...
              this.allDOMEventHandlers
            ), I(this._resetButton, "click", function() {
              a.toolTip.hide();
              ...
              0 >= navigator.userAgent.search("MSIE") && K(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" });
            ...
            }, this.allDOMEventHandlers), I(this._resetButton, "mousemove", function() {
              e || (K(a._resetButton, {
                backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                color: a.toolbar.fontColorOnHover,
                transition: "0.4s",
                WebkitTransition: "0.4s"
              }), 0 >= navigator.userAgent.search("MSIE") && K(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
        ...
        S2.prototype.render = function() {
          var a = this.bounds.x1, e = this.bounds.y1, c = this.markerMargin, b = this.maxWidth, f = this.maxHeight, h = this.markerSize, d2 = this.rows;
          ...
          for (var p2 = 0, l2 = 0; l2 < d2.length; l2++) {
            for (var k = d2[l2], m = 0, q = 0; q < k.items.length; q++) {
              var n = k.items[q], g = n.textBlock.x + a + (0 === q ? 0.2 * h : this.horizontalSpacing), v2 = e + p2, w = g;
              ...
              if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
                this.ctx.strokeStyle = n.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, v2 + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, v2 + this.lineHeight / 2), this.ctx.stroke(), w -= 0.1 * this.lineHeight;
              if ("error" === n.chartType) {
                this.ctx.strokeStyle = this.errorMarkerColor[0];
                this.ctx.lineWidth = h / 8;
                this.ctx.beginPath();
                var y = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, s = v2 + 0.15 * this.lineHeight, z = 0.7 * this.lineHeight, u = z + 0.02 * this.lineHeight;
                this.ctx.moveTo(y, s);
              ...
              Y.drawMarker(g + h / 2, v2 + this.lineHeight / 2, this.ctx, n.markerType, "error" === n.chartType || "line" === n.chartType || "spline" === n.chartType ? n.markerSize / 2 : n.markerSize, n.markerColor, n.markerBorderColor, n.markerBorderThickness);
              n.textBlock.x = g + c + h;
              if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
        ...
        oa.prototype.mouseMoveHandler = function(a, e) {
          this._lastUpdated && 4 > (/* @__PURE__ */ new Date()).getTime() - this._lastUpdated || (this._lastUpdated = (/* @__PURE__ */ new Date()).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, e), this.enabled && (this._updatedEventParameters && !isNaN(this._prevX) && !isNaN(this._prevY)) && this.dispatchEvent("updated", this._updatedEventParameters, this));
        };
          ...
          if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((b = this.chart.getObjectAtXY(c.x, c.y, false)) && "undefined" !== typeof this.objectMap[b])
              if (b = this.objectMap[b], "dataPoint" === b.objectType) {
                ...
                "legendItem" === b.objectType && (d2 = this.chart.data[b.dataSeriesIndex], h = null !== b.dataPointIndex ? d2.dataPoints[b.dataPointIndex] : null, b.eventParameter = { x: c.x, y: c.y, dataSeries: d2.options, dataPoint: h, dataPointIndex: b.dataPointIndex, dataSeriesIndex: b.dataSeriesIndex, chart: this.chart }, b.eventContext = { context: this.chart.legend, userContext: this.chart.legend.options, mouseover: "itemmouseover", mousemove: "itemmousemove", mouseout: "itemmouseout", click: "itemclick" }, e.push(b));
            d2 = [];
            for (c = 0; c < this.mouseoveredObjectMaps.length; c++) {
              ...
              h ? this.fireEvent(
                this.mouseoveredObjectMaps[c],
                "mouseout",
                a
              ) : d2.push(this.mouseoveredObjectMaps[c]);
            }
        ...
        var N = {
          yScaleAnimation: function(a, e) {
            if (0 !== a) {
              ...
              c.drawImage(b, 0, 0, b.width, b.height, 0, d2 - d2 * a, c.canvas.width / ma, a * c.canvas.height / ma);
            }
          },
          ...
          if (c) {
            ...
            c.lineWidth = p2 ? p2 : 0;
            c.setLineDash && c.setLineDash(H("solid", p2));
